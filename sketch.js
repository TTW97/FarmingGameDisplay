...
function setup() {
  ...
  //Trash can sprite
  trashCan = createSprite(950,200);
  trashCan.addImage(trashCanimg);
  trashCan.scale = 0.3;
  trashCan.visible = false;

  //Market sprite
  market = createSprite(950,500);
  ...
  rush = createSprite((displayWidth/2) - 110, (displayHeight/2) - 450);
  rush.addImage(rushimg);
  
  control = createSprite((displayWidth/2) - 140, (displayHeight/2) - 200);
  control.addImage(controlimg);

  controls = createSprite((displayWidth/2) - 350, (displayHeight/2));
  controls.addImage(controlsimg);
  controls.visible = false;

  how = createSprite((displayWidth/2) - 140, (displayHeight/2) + 200);
  how.addImage(howimg);
...
function draw() {
  ...
  if (gameState === "home") {
    ...
    text("Press C to see Controls", (displayWidth/2) - 250, (displayHeight/2 - 100));
    text("Press T to see How to play", (displayWidth/2) - 250, (displayHeight/2 + 300));
  ...
  if (gameState === "how") {
    ...
    fill("black");
    textSize(28);
    text("Press H to go back to Menu", (displayWidth/2), (displayHeight/2 - 480));
    textSize(20);
